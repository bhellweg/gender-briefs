...
\lhead{\includegraphics[width=1cm]{pdf/ao.pdf}\fontsize{22}{1}\selectfont\textbf{\  ANGOLA \textcolor{myblue}{GENDER LANDSCAPE}}}
...
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/hd-hci-lays/}{Learning-Adjusted Years of School}} & Male & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \includegraphics[width=0.1in, height=0.1in]{naicon.png} & \cellcolor{gray}{\textcolor{white}{\textbf{4.83}}} & \textcolor[HTML]{000004}{2020} & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \textcolor{gray}{NA}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{54.2} & \textcolor[HTML]{000004}{2001} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{53.4}}} & \textcolor[HTML]{000004}{2014} & \textcolor[HTML]{000004}{59.4} & \textcolor[HTML]{000004}{70.0} & \textcolor[HTML]{000004}{83.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/se-adt/}{Literacy rate (\% age 15+)}} & Male & \textcolor[HTML]{000004}{82.9} & \textcolor[HTML]{000004}{2001} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{80.0}}} & \textcolor[HTML]{000004}{2014} & \textcolor[HTML]{000004}{72.5} & \textcolor[HTML]{000004}{82.9} & \textcolor[HTML]{000004}{90.1}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{13.8} & \textcolor[HTML]{000004}{2009} & \includegraphics[width=0.1in, height=0.1in]{upicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{16.8}}} & \textcolor[HTML]{000004}{2011} & \textcolor[HTML]{000004}{41.3} & \textcolor[HTML]{000004}{76.9} & \textcolor[HTML]{000004}{77.3}\\
\nopagebreak
...
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-tlf-acti-zs/}{Labor force participation rate (\% age 15+, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{79.0} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{79.1}}} & \textcolor[HTML]{000004}{2021} & \textcolor[HTML]{000004}{71.7} & \textcolor[HTML]{000004}{72.0} & \textcolor[HTML]{000004}{71.7}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{17.1} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{12.7}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{18.8} & \textcolor[HTML]{000004}{33.5} & \textcolor[HTML]{000004}{54.6}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-emp-work-zs}{Wage and salaried workers (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{41.1} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{355F8D}{\textcolor{white}{\textbf{30.3}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{30.4} & \textcolor[HTML]{000004}{38.0} & \textcolor[HTML]{000004}{53.0}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{55.5} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{355F8D}{\textcolor{white}{\textbf{56.8}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{52.6} & \textcolor[HTML]{000004}{41.9} & \textcolor[HTML]{000004}{25.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-empl-zs}{Employment in agriculture (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{42.5} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{44.7}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{53.2} & \textcolor[HTML]{000004}{36.0} & \textcolor[HTML]{000004}{27.6}\\
\cmidrule{1-10}\pagebreak[0]
...
\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/hd-hci-ovrl}{A girl born in Angola will be 36 percent as productive as if she enjoyed complete education, health and employment (2020)}
\normalsize\end{minipage}}\hspace{0.25cm}
\fboxrule.6pt\fboxsep6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.6cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
\href{https://genderdata.worldbank.org/indicators/sh-sta-mmrt}{\textbf{2.4 per 1,000}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sh-sta-mmrt}{
2.4 per thousand 15-year-old girls in Angola are expected to die from a maternal related cause during their lifetimes (2017)}
\normalsize\end{minipage}} \hspace{0.25cm}
\fboxrule.6pt\fboxsep6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.6cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
\href{https://genderdata.worldbank.org/indicators/sg-vaw-afsx-zs}{\textbf{1 in 12}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sg-vaw-afsx-zs}{1 in 12 married women (15 to 49) in Angola report having been subjected to sexual violence during their lifetimes (2016)}
\normalsize\end{minipage}}\hspace{0.25cm}
\fboxrule.6pt\fboxsep6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.6cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
\href{https://genderdata.worldbank.org/indicators/sg-vaw-zs}{\textbf{1 in 4}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sg-vaw-zs}{1 in 4 surveyed married women in Angola believe it is ever justified for a man to beat his wife for any reason (2016)}
\normalsize\end{minipage}}\hspace{0.25cm}
\fboxrule.6pt\fboxsep6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.6cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering

\href{https://genderdata.worldbank.org/indicators/fin14abca-t-d}{\textbf{1.4 times likelier}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/fin14abca-t-d}{A man is 1.4 times likelier to have used the internet to pay bills or buy something online in the last year than a woman in Angola (2014)}
