...
\lhead{\includegraphics[width=1cm]{pdf/py.pdf}\fontsize{22}{1}\selectfont\textbf{\  PARAGUAY \textcolor{myblue}{GENDER LANDSCAPE}}}
...
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{14.8} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{355F8D}{\textcolor{white}{\textbf{13.3}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{12.7} & \textcolor[HTML]{000004}{12.2} & \textcolor[HTML]{000004}{14.8}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sh-dyn-ncom-zs}{Mortality from chronic vascular disease, cancer, diabetes or cardiorespiratory disease between 30 and 70 (\%)}} & Male & \textcolor[HTML]{000004}{19.7} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{355F8D}{\textcolor{white}{\textbf{18.6}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{17.1} & \textcolor[HTML]{000004}{21.1} & \textcolor[HTML]{000004}{21.7}\\
\cmidrule{1-10}\pagebreak[0]
\addlinespace[0.3em]
\multicolumn{10}{l}{\cellcolor{lightgray}{\textbf{ECONOMIC OPPORTUNITY}}}\\
 & Female & \textcolor[HTML]{000004}{52.9} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{upicon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{59.6}}} & \textcolor[HTML]{000004}{2021} & \textcolor[HTML]{000004}{48.5} & \textcolor[HTML]{000004}{55.5} & \textcolor[HTML]{000004}{46.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-tlf-acti-zs/}{Labor force participation rate (\% age 15+, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{82.2} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{84.2}}} & \textcolor[HTML]{000004}{2021} & \textcolor[HTML]{000004}{72.5} & \textcolor[HTML]{000004}{72.9} & \textcolor[HTML]{000004}{71.7}\\
\cmidrule{1-10}\pagebreak[0]
...
\cmidrule{1-10}\pagebreak[0]
\href{https://genderdata.worldbank.org/indicators/sg-vaw-1549-zs/}{Proportion of women subjected to physical and/or sexual violence in the last 12 months (\% of ever-partnered women ages 15-49)} &  & \textcolor[HTML]{000004}{8.00} & \textcolor[HTML]{000004}{2008} & \includegraphics[width=0.1in, height=0.1in]{naicon.png} & \cellcolor{gray}{\textcolor{white}{\textbf{NA}}} & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \textcolor{gray}{NA}\\*
\end{longtable}
\end{ThreePartTable}
\endgroup{}
...
\vspace{12pt}
\fontsize{14}{1}\selectfont 
\centering\tikz[baseline=(char.base)]{ \node[shape=circle,text width=30pt,align=center,draw=wbpurple,minimum size=30pt,outer sep=0pt,fill=wblight] (char) {\href{https://genderdata.worldbank.org/indicators/sg-law-indx}{94.4}};}
\vspace{.3cm}
...
\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sp-2024-fe-zs/}{21.6 percent of women ages 20 to 24 were first married by age 18 (2016)}
\normalsize\end{minipage}} \hspace{0.45cm}
\fboxrule.6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.3cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
...
\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sp-dyn-zs/}{32 percent of married women ages 15 to 49 do not report having access to contraceptives (2016)}
\normalsize\end{minipage}}\hspace{0.45cm}
\fboxrule.6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.3cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
...
\href{https://genderdata.worldbank.org/indicators/fin15-t-a}{\textbf{1.1 times}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/fin15-t-a}{A man is 1.1 times as likely as a woman to have borrowed money to start, operate, or expand a farm or business (2017)}
