...
\lhead{\includegraphics[width=1cm]{pdf/ga.pdf}\fontsize{22}{1}\selectfont\textbf{\  GABON \textcolor{myblue}{GENDER LANDSCAPE}}}
...
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/hd-hci-lays/}{Learning-Adjusted Years of School}} & Male & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \includegraphics[width=0.1in, height=0.1in]{naicon.png} & \cellcolor{gray}{\textcolor{white}{\textbf{5.81}}} & \textcolor[HTML]{000004}{2020} & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \textcolor{gray}{NA}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{65.3} & \textcolor[HTML]{000004}{1993} & \includegraphics[width=0.1in, height=0.1in]{upicon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{83.4}}} & \textcolor[HTML]{000004}{2018} & \textcolor[HTML]{000004}{59.4} & \textcolor[HTML]{000004}{94.5} & \textcolor[HTML]{000004}{83.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/se-adt/}{Literacy rate (\% age 15+)}} & Male & \textcolor[HTML]{000004}{79.4} & \textcolor[HTML]{000004}{1993} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{85.9}}} & \textcolor[HTML]{000004}{2018} & \textcolor[HTML]{000004}{72.5} & \textcolor[HTML]{000004}{97.1} & \textcolor[HTML]{000004}{90.1}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{18.8} & \textcolor[HTML]{000004}{1995} & \includegraphics[width=0.1in, height=0.1in]{upicon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{62.2}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{41.3} & \textcolor[HTML]{000004}{90.0} & \textcolor[HTML]{000004}{77.3}\\
\nopagebreak
...
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-tlf-acti-zs/}{Labor force participation rate (\% age 15+, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{57.7} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{57.0}}} & \textcolor[HTML]{000004}{2021} & \textcolor[HTML]{000004}{71.7} & \textcolor[HTML]{000004}{72.9} & \textcolor[HTML]{000004}{71.7}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{59.8} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{63.6}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{18.8} & \textcolor[HTML]{000004}{60.2} & \textcolor[HTML]{000004}{54.6}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-emp-work-zs}{Wage and salaried workers (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{69.6} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{68.8}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{30.4} & \textcolor[HTML]{000004}{60.8} & \textcolor[HTML]{000004}{53.0}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{53.2} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{45.8}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{52.6} & \textcolor[HTML]{000004}{17.8} & \textcolor[HTML]{000004}{25.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-empl-zs}{Employment in agriculture (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{25.1} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{21.0}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{53.2} & \textcolor[HTML]{000004}{23.5} & \textcolor[HTML]{000004}{27.6}\\
\cmidrule{1-10}\pagebreak[0]
...
\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sp-2024-fe-zs}{27.6 percent of women 15 to 19 years old have had children or already pregnant (2012)}
\normalsize\end{minipage}} \hspace{0.45cm}
\fboxrule.6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.3cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
\href{https://genderdata.worldbank.org/indicators/sg-vaw-afsx-zs}{\textbf{22.8 percent}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sg-vaw-afsx-zs}{22.8 percent of women report having ever experienced any form of sexual violence (2012)}
\normalsize\end{minipage}}\hspace{0.45cm}
\fboxrule.6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.3cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering
...
\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sg-dmk}{30 percent of women are not able to visit family, relatives and friends on her own decision (2012)}
\normalsize\end{minipage}}\hspace{0.45cm}
\fboxrule.6pt\fcolorbox{white}{white}{\color{black}
\begin{minipage}[c][3.3cm][t]{3.15cm}
\vspace{.15cm}\fontsize{10}{5}\centering

\href{https://genderdata.worldbank.org/indicators/sg-own-ld}{\textbf{33 in 34}}

\centering\rule{2.5cm}{0.5pt}
\vspace{.15cm}

\fontsize{9}{5}\selectfont\href{https://genderdata.worldbank.org/indicators/sg-own-ld}{97.1 percent of women do not have any land, both solely and jointly, registered under their name (2012)}
