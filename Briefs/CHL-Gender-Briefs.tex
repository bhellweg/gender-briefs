...
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{10.5} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{8.30}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{12.7} & \textcolor[HTML]{000004}{8.87} & \textcolor[HTML]{000004}{14.8}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sh-dyn-ncom-zs}{Mortality from chronic vascular disease, cancer, diabetes or cardiorespiratory disease between 30 and 70 (\%)}} & Male & \textcolor[HTML]{000004}{15.7} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{12.0}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{17.1} & \textcolor[HTML]{000004}{14.5} & \textcolor[HTML]{000004}{21.7}\\
\cmidrule{1-10}\pagebreak[0]
\addlinespace[0.3em]
\multicolumn{10}{l}{\cellcolor{lightgray}{\textbf{ECONOMIC OPPORTUNITY}}}\\
 & Female & \textcolor[HTML]{000004}{45.6} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/righticon.png} & \cellcolor[HTML]{355F8D}{\textcolor{white}{\textbf{44.2}}} & \textcolor[HTML]{000004}{2021} & \textcolor[HTML]{000004}{48.5} & \textcolor[HTML]{000004}{53.3} & \textcolor[HTML]{000004}{46.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-tlf-acti-zs}{Labor force participation rate (\% 15+, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{72.4} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{65.5}}} & \textcolor[HTML]{000004}{2021} & \textcolor[HTML]{000004}{72.5} & \textcolor[HTML]{000004}{67.4} & \textcolor[HTML]{000004}{71.7}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{75.1} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{74.2}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{63.5} & \textcolor[HTML]{000004}{90.3} & \textcolor[HTML]{000004}{54.6}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-emp-work-zs}{Wage and salaried workers (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{72.5} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{71.8}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{61.2} & \textcolor[HTML]{000004}{85.9} & \textcolor[HTML]{000004}{53.0}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{5.14} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{4.74}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{7.08} & \textcolor[HTML]{000004}{1.88} & \textcolor[HTML]{000004}{25.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-empl-zs}{Employment in agriculture (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{14.1} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{12.0}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{18.0} & \textcolor[HTML]{000004}{3.44} & \textcolor[HTML]{000004}{27.6}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{24.5} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{icon/righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{22.5}}} & \textcolor[HTML]{000004}{2020} & \textcolor[HTML]{000004}{29.5} & \textcolor[HTML]{000004}{13.5} & \textcolor{gray}{NA}\\
\nopagebreak
