...
This briefing showcases the gender landscape in Central African Republic on key indicators helpful for monitoring gender equality and designing effective policy interventions. Gender equality fosters productivity gains, minimizes losses in wealth, reduces poverty, boosts shared prosperity, and supports green, resilient, and inclusive development. Central African Republic is a Fragile, Conflict, or Violence (FCV) impacted country in medium-intensity conflict. 
...
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{24.4} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{25.8}}} & \textcolor[HTML]{000004}{2018} & \textcolor[HTML]{000004}{59.4} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{83.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/se-adt}{Literacy rate (\% 15+)}} & Male & \textcolor[HTML]{000004}{50.7} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{49.5}}} & \textcolor[HTML]{000004}{2018} & \textcolor[HTML]{000004}{72.5} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{90.1}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{29.0} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{upicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{44.8}}} & \textcolor[HTML]{000004}{2017} & \textcolor[HTML]{000004}{68.8} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{89.9}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/se-prm-cmpt-zs}{Primary completion rate (\% of relevant group)}} & Male & \textcolor[HTML]{000004}{49.4} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{upicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{64.6}}} & \textcolor[HTML]{000004}{2017} & \textcolor[HTML]{000004}{71.9} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{90.3}\\
\cmidrule{1-10}\pagebreak[0]
...
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{2.00} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{1.20}}} & \textcolor[HTML]{000004}{2020} & \textcolor[HTML]{000004}{1.68} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{0.40}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sh-hiv-1524-zs}{Prevalence of HIV (\% 15-24)}} & Male & \textcolor[HTML]{000004}{1.20} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{355F8D}{\textcolor{white}{\textbf{0.70}}} & \textcolor[HTML]{000004}{2020} & \textcolor[HTML]{000004}{0.74} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{0.20}\\
\cmidrule{1-10}\pagebreak[0]
\addlinespace[0.3em]
...
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{4.37} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{downicon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{3.20}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{18.8} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{54.6}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-emp-work-zs}{Wage and salaried workers (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{9.41} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{482576}{\textcolor{white}{\textbf{9.90}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{30.4} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{53.0}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor[HTML]{000004}{75.9} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{72.6}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{52.6} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{25.3}\\
\nopagebreak
\multirow{-2}{9cm}{\raggedright\arraybackslash \href{https://genderdata.worldbank.org/indicators/sl-empl-zs}{Employment in agriculture (\% of employment, modeled ILO estimate)}} & Male & \textcolor[HTML]{000004}{69.7} & \textcolor[HTML]{000004}{2010} & \includegraphics[width=0.1in, height=0.1in]{righticon.png} & \cellcolor[HTML]{21908C}{\textcolor{white}{\textbf{67.5}}} & \textcolor[HTML]{000004}{2019} & \textcolor[HTML]{000004}{53.2} & \textcolor{gray}{NA} & \textcolor[HTML]{000004}{27.6}\\
\cmidrule{1-10}\pagebreak[0]
 & Female & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \includegraphics[width=0.1in, height=0.1in]{naicon.png} & \cellcolor{gray}{\textcolor{white}{\textbf{NA}}} & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \textcolor{gray}{NA} & \textcolor{gray}{NA}\\
\nopagebreak
